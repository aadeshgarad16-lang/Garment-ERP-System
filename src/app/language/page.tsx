        ...
        <div className="bg-white py-8 px-4 shadow-xl shadow-neutral-200/50 sm:rounded-2xl sm:px-10 border border-neutral-100">
          <div className="space-y-4">
            {languages.map((lang) => (
              <button
                ...
                className="w-full flex items-center justify-between p-4 border border-neutral-200 rounded-xl hover:border-blue-500 hover:ring-1 hover:ring-blue-500 hover:bg-blue-50 transition-all group"
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-neutral-900 font-medium">{lang.name}</span>
                </div>
          ...
          <div className="mt-8">
            <div className="relative flex justify-center text-sm">
              <span className="bg-white px-2 text-neutral-500 text-center">
